	...
	<div class="container">
			...
			<div class="part-detail col-6">
				<form>
					<div class="form-group">
						<label for="msold">판매/나눔</label> <input readonly id="msold"
							class="form-control" name="msold" value="${market.msold }">
					</div>

					<div class="form-group">
						<label for="mtitle">상품명</label> <input readonly id="mtitle"
							class="form-control" name="mtitle" value="${market.mtitle }">
					</div>

					<div class="form-group">
						<label for="mprice">가격</label> <input readonly id="mprice"
							class="form-control" name="mprice" value="${market.mprice }">

					</div>

					<div class="form-group">
						<label for="mstate">상품상태</label> <input readonly id="mstate"
							class="form-control" name="mstate" value="${market.mstate }">
					</div>

					<div class="form-group">
						<label for="maddress">거래지역</label> <input readonly id="maddress"
							class="form-control" name="maddress" value="${market.maddress }">
					</div>

					<div class="form-group">
						<label for="mwriter">작성자</label> <input readonly id="mwriter"
							class="form-control" name="mwriter" value="${market.mwriter }">
					</div>

					<div class="form-group">
						<label for="mregdate">게시 날짜</label> <span readonly
							class="form-control" id="mregdate" name="mregdate"><fmt:formatDate
								pattern="yyyy-MM-dd" value="${market.mregdate }" /></span>
					</div>

					<!-- <button type="button" class="btn btncl" id="market_heart"><i class="far fa-heart"></i> 찜하기 </button>
				<i class="fas fa-heart"></i> 검은하트 -->

					<button type="button" class="btn btncl" id="market_dm"
						data-toggle="modal" data-target="#callsec">
							...
							<form action="${appRoot }/message/mgsend" method="post">
								<div class="form-group">
									<label for="writer" class="col-form-label">보내는 사람</label> <input
										...
										value="${pinfo.user.userid}" name="writer">
								</div>

								<div class="form-group">
									<label for="reader" class="col-form-label">받는 사람</label> <input
										type="text" readonly class="form-control" id="readerTh"
										value="${market.mwriter}" name="reader">
								</div>
		...
		<form>
			...
			<div class="form-group">
				...
				<textarea readonly="readonly" id="mdetail" class="form-control"
					name="mdetail">${market.mdetail }</textarea>
			</div>
		</form>
		<div>
