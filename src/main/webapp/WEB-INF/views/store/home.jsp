	...
	<div class="container">
		...
		<div class="row">
			<div class="col-2">
				<ul class="nav flex-column">
					<li class="nav-item"><a class="nav-link btn-light active"
						href="${appRoot }/store/home">카테고리</a></li>
					<li class="nav-item"><a class="nav-link btn-outline-secondary"
						href="${appRoot }/store/home2">가구</a></li>
					<li class="nav-item"><a class="nav-link btn-outline-secondary"
						href="#">수납</a></li>
					<li class="nav-item"><a class="nav-link btn-outline-secondary"
						href="#">조명</a></li>
			...
			<div class="col-10">
				...
				<div id="carouselExampleInterval" class="carousel slide"
					...
					<div class="carousel-inner">
						<div class="carousel-item active" data-interval="3000">
							<a href="${appRoot }/main/tos"><img
								src="${appRoot }/resources/img/store_01.png"
								class="d-block w-100" id="carousel-size"></a>
						</div>
						<div class="carousel-item" data-interval="3000">
							<a href="${appRoot }/main/home"><img
								src="${appRoot }/resources/img/store_02.png"
								class="d-block w-100" id="carousel-size"></a>
						</div>
					</div>
				...
				<div class="keyword">
					<ul class="nav">
						<li class="nav-item"><a class="nav-link active" href="#">#침실</a>
						</li>
						<li class="nav-item"><a class="nav-link" href="#">#서재</a></li>
						<li class="nav-item"><a class="nav-link" href="#">#드레스룸</a></li>
						<li class="nav-item"><a class="nav-link" href="#">#거실</a></li>
						<li class="nav-item"><a class="nav-link" href="#">#주방</a></li>
						<li class="nav-item"><a class="nav-link" href="#">#욕실</a></li>
						<li class="nav-item"><a class="nav-link" href="#">#테라스</a></li>
					</ul>
				</div>
							...
							<a href="${getUrl}">
								<div class="col mb-3">
									<div class="card">
										...
										<img src="${imgRoot}store/${store.pno }/${store.fileName[0]}"
											class="card-img-top">
										<div class="card-body">
	   ...
	   --%>
						...
						<div style="display: none;">
							<form id="actionForm" action="${appRoot }/store/home"
								method="get">
